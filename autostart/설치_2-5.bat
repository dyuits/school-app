...
title Classroom 2-5 Install
echo Installing Classroom 2-5...
...
del "%LOCALAPPDATA%\ClassroomAlert\2-5\watcher.lock" >nul 2>&1
...
echo.
echo [OK] Classroom 2-5 installed.
echo - Auto-start on boot: YES
echo - Auto-restart Chrome: YES
echo - Remove: run remove_2-5.bat
timeout /t 3
