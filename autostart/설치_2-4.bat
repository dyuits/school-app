...
title Classroom 2-4 Install
echo Installing Classroom 2-4...
...
del "%LOCALAPPDATA%\ClassroomAlert\2-4\watcher.lock" >nul 2>&1
...
>> "%VBS%" echo sUserData = sParent ^& "\2-4"
...
echo.
echo [OK] Classroom 2-4 installed.
echo - Auto-start on boot: YES
echo - Auto-restart Chrome: YES
echo - Remove: run remove_2-4.bat
timeout /t 3
