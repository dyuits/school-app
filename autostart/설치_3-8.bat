...
title Classroom 3-8 Install
echo Installing Classroom 3-8...
...
set "URL=https://dyuits.github.io/school-app/classroom/3-8.html"
set "USERDATA=%LOCALAPPDATA%\ClassroomAlert\3-8"

taskkill /f /im wscript.exe >nul 2>&1
timeout /t 3 /nobreak >nul
del "%LOCALAPPDATA%\ClassroomAlert\3-8\watcher.lock" >nul 2>&1
...
set "VBS=%STARTUP%\ClassroomAlert_3-8.vbs"
...
>> "%VBS%" echo sUserData = sParent ^& "\3-8"
...
echo.
echo [OK] Classroom 3-8 installed.
echo - Auto-start on boot: YES
echo - Auto-restart Chrome: YES
echo - Remove: run remove_3-8.bat
timeout /t 3
