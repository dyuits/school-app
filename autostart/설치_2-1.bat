...
title Classroom 2-1 Install
echo Installing Classroom 2-1...
...
set "USERDATA=%LOCALAPPDATA%\ClassroomAlert\2-1"

taskkill /f /im wscript.exe >nul 2>&1
timeout /t 3 /nobreak >nul
del "%LOCALAPPDATA%\ClassroomAlert\2-1\watcher.lock" >nul 2>&1
...
set "VBS=%STARTUP%\ClassroomAlert_2-1.vbs"
...
>> "%VBS%" echo sUserData = sParent ^& "\2-1"
...
echo.
echo [OK] Classroom 2-1 installed.
echo - Auto-start on boot: YES
echo - Auto-restart Chrome: YES
echo - Remove: run remove_2-1.bat
timeout /t 3
