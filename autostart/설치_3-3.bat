...
title Classroom 3-3 Install
echo Installing Classroom 3-3...
...
set "USERDATA=%LOCALAPPDATA%\ClassroomAlert\3-3"

taskkill /f /im wscript.exe >nul 2>&1
timeout /t 3 /nobreak >nul
del "%LOCALAPPDATA%\ClassroomAlert\3-3\watcher.lock" >nul 2>&1
...
>> "%VBS%" echo sUserData = sParent ^& "\3-3"
...
echo.
echo [OK] Classroom 3-3 installed.
echo - Auto-start on boot: YES
echo - Auto-restart Chrome: YES
echo - Remove: run remove_3-3.bat
timeout /t 3
