...
title Classroom 1-3 Install
echo Installing Classroom 1-3...
...
set "URL=https://dyuits.github.io/school-app/classroom/1-3.html"
set "USERDATA=%LOCALAPPDATA%\ClassroomAlert\1-3"

taskkill /f /im wscript.exe >nul 2>&1
timeout /t 3 /nobreak >nul
del "%LOCALAPPDATA%\ClassroomAlert\1-3\watcher.lock" >nul 2>&1
...
set "VBS=%STARTUP%\ClassroomAlert_1-3.vbs"
...
>> "%VBS%" echo sUserData = sParent ^& "\1-3"
...
echo.
echo [OK] Classroom 1-3 installed.
echo - Auto-start on boot: YES
echo - Auto-restart Chrome: YES
echo - Remove: run remove_1-3.bat
timeout /t 3
