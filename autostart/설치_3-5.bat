...
title Classroom 3-5 Install
echo Installing Classroom 3-5...
...
set "URL=https://dyuits.github.io/school-app/classroom/3-5.html"
set "USERDATA=%LOCALAPPDATA%\ClassroomAlert\3-5"

taskkill /f /im wscript.exe >nul 2>&1
timeout /t 3 /nobreak >nul
del "%LOCALAPPDATA%\ClassroomAlert\3-5\watcher.lock" >nul 2>&1
...
set "VBS=%STARTUP%\ClassroomAlert_3-5.vbs"
...
>> "%VBS%" echo sUserData = sParent ^& "\3-5"
...
echo.
echo [OK] Classroom 3-5 installed.
echo - Auto-start on boot: YES
echo - Auto-restart Chrome: YES
echo - Remove: run remove_3-5.bat
timeout /t 3
