...
set "CLS=3-9"
set "URL=https://dyuits.github.io/school-app/classroom/3-9.html"
...
set "VBS=%STARTUP%\ClassroomAlert_3-9.vbs"
> "%VBS%" echo Set s = CreateObject("WScript.Shell")
>> "%VBS%" echo s.Run "powershell.exe -ExecutionPolicy Bypass -WindowStyle Hidden -File " ^& Chr(34) ^& s.ExpandEnvironmentStrings("%%LOCALAPPDATA%%") ^& "\ClassroomAlert\ClassroomAlert.ps1" ^& Chr(34) ^& " -CLS 3-9", 0, False
