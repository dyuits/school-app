...
title Classroom 1-4 Install
echo Installing Classroom 1-4...
...
set "URL=https://dyuits.github.io/school-app/classroom/1-4.html"
set "USERDATA=%LOCALAPPDATA%\ClassroomAlert\1-4"

taskkill /f /im wscript.exe >nul 2>&1
timeout /t 3 /nobreak >nul
del "%LOCALAPPDATA%\ClassroomAlert\1-4\watcher.lock" >nul 2>&1
...
set "VBS=%STARTUP%\ClassroomAlert_1-4.vbs"
...
>> "%VBS%" echo sUserData = sParent ^& "\1-4"
...
echo.
echo [OK] Classroom 1-4 installed.
echo - Auto-start on boot: YES
echo - Auto-restart Chrome: YES
echo - Remove: run remove_1-4.bat
timeout /t 3
