...
>> "%VBS%" echo s.Run "powershell.exe -ExecutionPolicy Bypass -WindowStyle Hidden -File " ^& Chr(34) ^& s.ExpandEnvironmentStrings("%%LOCALAPPDATA%%") ^& "\ClassroomAlert\ClassroomAlert.ps1" ^& Chr(34) ^& " -CLS 1-4", 0, False
