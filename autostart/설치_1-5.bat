...
title Classroom 1-5 Install
echo Installing Classroom 1-5...
...
set "URL=https://dyuits.github.io/school-app/classroom/1-5.html"
set "USERDATA=%LOCALAPPDATA%\ClassroomAlert\1-5"

taskkill /f /im wscript.exe >nul 2>&1
timeout /t 3 /nobreak >nul
del "%LOCALAPPDATA%\ClassroomAlert\1-5\watcher.lock" >nul 2>&1
...
set "VBS=%STARTUP%\ClassroomAlert_1-5.vbs"
...
>> "%VBS%" echo sUserData = sParent ^& "\1-5"
...
echo.
echo [OK] Classroom 1-5 installed.
echo - Auto-start on boot: YES
echo - Auto-restart Chrome: YES
echo - Remove: run remove_1-5.bat
timeout /t 3
