...
title Classroom 3-10 Install
echo Installing Classroom 3-10...
...
set "USERDATA=%LOCALAPPDATA%\ClassroomAlert\3-10"

taskkill /f /im wscript.exe >nul 2>&1
timeout /t 3 /nobreak >nul
del "%LOCALAPPDATA%\ClassroomAlert\3-10\watcher.lock" >nul 2>&1
...
set "VBS=%STARTUP%\ClassroomAlert_3-10.vbs"
...
echo.
echo [OK] Classroom 3-10 installed.
echo - Auto-start on boot: YES
echo - Auto-restart Chrome: YES
echo - Remove: run remove_3-10.bat
timeout /t 3
