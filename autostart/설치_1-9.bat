...
title Classroom 1-9 Install
echo Installing Classroom 1-9...
...
del "%LOCALAPPDATA%\ClassroomAlert\1-9\watcher.lock" >nul 2>&1
...
echo.
echo [OK] Classroom 1-9 installed.
echo - Auto-start on boot: YES
echo - Auto-restart Chrome: YES
echo - Remove: run remove_1-9.bat
timeout /t 3
