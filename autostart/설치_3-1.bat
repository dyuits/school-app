...
title Classroom 3-1 Install
echo Installing Classroom 3-1...
...
set "URL=https://dyuits.github.io/school-app/classroom/3-1.html"
set "USERDATA=%LOCALAPPDATA%\ClassroomAlert\3-1"

taskkill /f /im wscript.exe >nul 2>&1
timeout /t 3 /nobreak >nul
del "%LOCALAPPDATA%\ClassroomAlert\3-1\watcher.lock" >nul 2>&1
...
set "VBS=%STARTUP%\ClassroomAlert_3-1.vbs"
...
>> "%VBS%" echo sUserData = sParent ^& "\3-1"
...
echo.
echo [OK] Classroom 3-1 installed.
echo - Auto-start on boot: YES
echo - Auto-restart Chrome: YES
echo - Remove: run remove_3-1.bat
timeout /t 3
