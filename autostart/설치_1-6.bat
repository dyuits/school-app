...
title Classroom 1-6 Install
echo Installing Classroom 1-6...
...
set "URL=https://dyuits.github.io/school-app/classroom/1-6.html"
set "USERDATA=%LOCALAPPDATA%\ClassroomAlert\1-6"

taskkill /f /im wscript.exe >nul 2>&1
timeout /t 3 /nobreak >nul
del "%LOCALAPPDATA%\ClassroomAlert\1-6\watcher.lock" >nul 2>&1
...
set "VBS=%STARTUP%\ClassroomAlert_1-6.vbs"
...
echo.
echo [OK] Classroom 1-6 installed.
echo - Auto-start on boot: YES
echo - Auto-restart Chrome: YES
echo - Remove: run remove_1-6.bat
timeout /t 3
