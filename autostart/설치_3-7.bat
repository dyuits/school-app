...
title Classroom 3-7 Install
echo Installing Classroom 3-7...
...
set "URL=https://dyuits.github.io/school-app/classroom/3-7.html"
set "USERDATA=%LOCALAPPDATA%\ClassroomAlert\3-7"

taskkill /f /im wscript.exe >nul 2>&1
timeout /t 3 /nobreak >nul
del "%LOCALAPPDATA%\ClassroomAlert\3-7\watcher.lock" >nul 2>&1
...
set "VBS=%STARTUP%\ClassroomAlert_3-7.vbs"
...
>> "%VBS%" echo sUserData = sParent ^& "\3-7"
...
echo.
echo [OK] Classroom 3-7 installed.
echo - Auto-start on boot: YES
echo - Auto-restart Chrome: YES
echo - Remove: run remove_3-7.bat
timeout /t 3
