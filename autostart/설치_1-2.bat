...
title Classroom 1-2 Install
echo Installing Classroom 1-2...
...
set "USERDATA=%LOCALAPPDATA%\ClassroomAlert\1-2"

taskkill /f /im wscript.exe >nul 2>&1
timeout /t 3 /nobreak >nul
del "%LOCALAPPDATA%\ClassroomAlert\1-2\watcher.lock" >nul 2>&1
...
set "VBS=%STARTUP%\ClassroomAlert_1-2.vbs"
...
echo.
echo [OK] Classroom 1-2 installed.
echo - Auto-start on boot: YES
echo - Auto-restart Chrome: YES
echo - Remove: run remove_1-2.bat
timeout /t 3
