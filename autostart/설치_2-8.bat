...
title Classroom 2-8 Install
echo Installing Classroom 2-8...
...
set "URL=https://dyuits.github.io/school-app/classroom/2-8.html"
set "USERDATA=%LOCALAPPDATA%\ClassroomAlert\2-8"

taskkill /f /im wscript.exe >nul 2>&1
timeout /t 3 /nobreak >nul
del "%LOCALAPPDATA%\ClassroomAlert\2-8\watcher.lock" >nul 2>&1
...
set "VBS=%STARTUP%\ClassroomAlert_2-8.vbs"
...
>> "%VBS%" echo sUserData = sParent ^& "\2-8"
...
echo.
echo [OK] Classroom 2-8 installed.
echo - Auto-start on boot: YES
echo - Auto-restart Chrome: YES
echo - Remove: run remove_2-8.bat
timeout /t 3
