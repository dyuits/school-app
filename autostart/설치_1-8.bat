...
title Classroom 1-8 Install
echo Installing Classroom 1-8...
...
set "URL=https://dyuits.github.io/school-app/classroom/1-8.html"
set "USERDATA=%LOCALAPPDATA%\ClassroomAlert\1-8"

taskkill /f /im wscript.exe >nul 2>&1
timeout /t 3 /nobreak >nul
del "%LOCALAPPDATA%\ClassroomAlert\1-8\watcher.lock" >nul 2>&1
...
set "VBS=%STARTUP%\ClassroomAlert_1-8.vbs"
...
>> "%VBS%" echo sUserData = sParent ^& "\1-8"
...
echo.
echo [OK] Classroom 1-8 installed.
echo - Auto-start on boot: YES
echo - Auto-restart Chrome: YES
echo - Remove: run remove_1-8.bat
timeout /t 3
