...
powershell -Command "Get-Process powershell -ErrorAction SilentlyContinue | Where-Object {$_.CommandLine -like '*교실알림*2-10*'} | Stop-Process -Force" >nul 2>&1
:: 기존 VBS 프로세스 종료
...
del "%STARTUP%\교실알림_2-10.bat" >nul 2>&1
