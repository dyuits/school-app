...
title Classroom 2-7 Install
echo Installing Classroom 2-7...
...
set "URL=https://dyuits.github.io/school-app/classroom/2-7.html"
set "USERDATA=%LOCALAPPDATA%\ClassroomAlert\2-7"

taskkill /f /im wscript.exe >nul 2>&1
timeout /t 3 /nobreak >nul
del "%LOCALAPPDATA%\ClassroomAlert\2-7\watcher.lock" >nul 2>&1
...
set "VBS=%STARTUP%\ClassroomAlert_2-7.vbs"
...
>> "%VBS%" echo sUserData = sParent ^& "\2-7"
...
echo.
echo [OK] Classroom 2-7 installed.
echo - Auto-start on boot: YES
echo - Auto-restart Chrome: YES
echo - Remove: run remove_2-7.bat
timeout /t 3
