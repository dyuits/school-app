...
assert(afterSchoolStyles.includes('.title-table td.sign-cell{height:70px!important}') && afterSchoolStyles.includes('.title-table,body.afterschool-printing #afterSchoolPrintSheet .info-table,body.afterschool-printing #afterSchoolPrintSheet .attendance-table{border:1px solid #000!important}'), '출석부 결재란 높이 또는 전체 테두리 통일 오류');
assert(afterSchoolSource.includes('.title-table td.sign-cell{height:70px!important}') && afterSchoolSource.includes('.title-table,.info-table,.attendance-table{border:1px solid #000}'), '한글 다운로드 결재란 높이 또는 전체 테두리 통일 오류');
